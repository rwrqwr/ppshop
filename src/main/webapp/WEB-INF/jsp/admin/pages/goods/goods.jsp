...
<div class="weadmin-body">
    <div class="demoTable">
        ...
        <button class="layui-btn" onclick="WeAdminShow('添加商品','/admin/addGoods',900,600)"><i class="layui-icon"></i>添加</button>
    </div>
    <%--<div class="layui-row">
        会员搜索：
            <div class="layui-inline">
...
<script>
    ...
    layui.use('table', function(){
        ...
        var tableIns = table.render({
            ...
            ,cols: [[ //表头
                {type:'checkbox'}
                ,{field: 'spuNo', title: 'ID', width:80, sort: true}
                ,{field: 'goodsName', title: '商品名称', width:250}
                ,{field: 'price', title: '单价', width:150}
                ,{field: 'cateGoryId', title: '类别编号', width:150}
                ,{field:'brandId', title:'厂商编号', width:150}
                ,{field: 'spuQuantity', title: '库存', width:200}
                ,{field: 'description', title: '商品描述', width:300}
